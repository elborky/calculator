...
| # | Task | Status |
|---|---|---|
| T-006 | Define `Operator` union type in `src/types.ts` | [PENDING] |
| T-007 | Define `ErrorTag` union type in `src/types.ts` | [PENDING] |
...
| # | Task | Status |
|---|---|---|
| T-011 | Create `src/decimal-config.ts` with precision/rounding/exp-bounds config | [PENDING] |
...
| # | Task | Status |
|---|---|---|
| T-013 | Implement `inputDigit(state, digit)` in `src/engine.ts` | [PENDING] |
| T-014 | Test: `inputDigit — appends digit normally` | [PENDING] |
...
| # | Task | Status |
|---|---|---|
| T-019 | Implement `inputDecimal(state)` in `src/engine.ts` | [PENDING] |
...
| # | Task | Status |
|---|---|---|
| T-040 | Implement `inputEquals(state)` in `src/engine.ts` | [PENDING] |
...
| # | Task | Status |
|---|---|---|
| T-081 | Run `tsc --noEmit` — zero type errors | [PENDING] |
